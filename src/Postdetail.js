          ...
          <MDBRow>
            <MDBCol md="12">
              ...
              <MDBNav className="mt-5 nav-pills">
                <MDBNavItem>
                  <MDBNavLink link to="#/1" active={this.state.items["default"] === "1"} onClick={this.togglePills("default", "1")} >
                    Home
                  </MDBNavLink>
                </MDBNavItem>
                <MDBNavItem>
                  <MDBNavLink link to="#/2" active={this.state.items["default"] === "2"} onClick={this.togglePills("default", "2")} >
                    Profile
                  </MDBNavLink>
                </MDBNavItem>
                <MDBNavItem>
